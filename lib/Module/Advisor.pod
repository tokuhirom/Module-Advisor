...
E<lt>1.16 have a security issue. which could lead to the injection of arbitrary Perl code
...
E<lt>1.15 have timezone related issue
...
E<lt>1.6001 possibly memory leaks on VM stack frames. see https://github.com/xslate/p5-Text-Xslate/issues/71
